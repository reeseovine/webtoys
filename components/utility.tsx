...
const StatusGood = ({ size = 1, className = '' }: StatusProps) => (
	<Icon path={mdiCheck} size={size} className={`${className} text-lime-600 dark:text-lime-500`} />
)
const StatusBad = ({ size = 1, className = '' }: StatusProps) => (
	<Icon path={mdiClose} size={size} className={`${className} text-red-500 dark:text-red-500`} />
)
...
export { ToolTip, StatusGood, StatusBad, StatusLoading }
